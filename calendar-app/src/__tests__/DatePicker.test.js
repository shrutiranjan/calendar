...
//import App from './App'
import DatePicker, {MONTHS_NAME} from '../DatePicker'
...
describe(`By default, when no props are passed`, () => {
  ...
  // it('should apply different classes for dates displayed from prev & next month', fail)
  // it('should fill the missing cells in the month in the grid with dates from previous & next months', fail)
  // it(
